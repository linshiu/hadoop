...
public class lin_rehman_exercise2 {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		    ...
		    if (!line.isEmpty()){
				...
				// or one or more white space "\\s+" since 2gram the two words are not separated by tab
		       	ArrayList<String> recordS = new ArrayList<String>(Arrays.asList(line.split("\t")));
		       	ArrayList<String> recordSub = new ArrayList<String>(recordS.subList(19,28));
		       	ArrayList<Double> record = convertToDouble(recordSub);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(lin_rehman_exercise2.class);
